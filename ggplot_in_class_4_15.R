...
inaugFeatures <- topfeatures(mobydick_dfm, 100)
mobydick_dfm <- dfm(data_char_mobydick, remove =  stopwords('english') , remove_punct = TRUE)
...
ggplot(topDf, aes(x = rank, y = frequency)) + geom_smooth()
