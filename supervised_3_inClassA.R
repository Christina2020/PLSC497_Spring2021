...
#trctrl <- trainControl(method = "LOOCV", p = 0.8) # this was commented out 
?trainControl
...
#Baseline Accuracy:  0.6564039 
#SVM-Linear Accuracy: 0.7770936 
#SVM-Radial Accuracy: 0.6773399
# Above we have to results form where p = .80 and as you can see the accuracy is high becasse
# we are using most of the data

#Baseline Accuracy:  0.652829 
#SVM-Linear Accuracy: 0.7278598 
#SVM-Radial Accuracy: 0.652829
# above we dorped the p = .20 and the accuracy for both Linear and Radial drop becase
# we are not use most of the data to predicted the accuracy 